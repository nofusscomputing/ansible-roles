...
pip install -r ./gitlab-ci/ansible/requirements.txt

echo "[DEBUG] install python requirements for commitizen"
pip install -r ./gitlab-ci/conventional_commits/requirements.txt

echo "[DEBUG] install python module cz_nfc"
pip install gitlab-ci/gitlab_release/python-module/cz_nfc/.
